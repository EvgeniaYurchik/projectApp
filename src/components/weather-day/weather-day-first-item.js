...
import withWeatherDayFirstItem from './with-weather-day-first-item'

const WeatherDayFirstItem = ({ list }) => 
...
export default withWeatherDayFirstItem(WeatherDayFirstItem);